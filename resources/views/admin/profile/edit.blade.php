...
@section('title','Profile Update Page')
@section('content')
<!-- MAIN CONTENT-->
                        ...
                        @csrf
                         ...
                         <div class="row col-6">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input id="cc-pament" name="phone" type="number" value="{{Auth::user()->phone}}" class="form-control" aria-required="true" aria-invalid="false" placeholder="Enter Phone...">
                            </div>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <textarea name="address" class="form-control" cols="30" rows="10" placeeholder="Enter Address...">{{Auth::user()->address}}</textarea>
                            </div>
